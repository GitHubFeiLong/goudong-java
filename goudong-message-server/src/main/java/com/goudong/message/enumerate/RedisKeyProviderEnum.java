...
public enum RedisKeyProviderEnum implements RedisKeyProvider {
     ...
     * 保存邮箱验证码
     */
    EMAIL_CODE("goudong-message-server:code:email:${email}", DataType.STRING, String.class, 5, TimeUnit.MINUTES),

    /**
     * 保存手机短信验证码
     */
    PHONE_CODE("goudong-message-server:code:phone:${phone}", DataType.STRING, String.class, 5, TimeUnit.MINUTES),
