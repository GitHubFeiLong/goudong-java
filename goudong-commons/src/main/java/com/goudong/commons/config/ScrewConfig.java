...
public class ScrewConfig {
    ...
    private static final ScrewConfig SCREW = new ScrewConfig();
     ...
     * @return
     */
    public static ScrewConfig getInstance(Environment environment){
    ...
    public ScrewConfig environment(Environment environment) {
        this.environment = environment;
        return this;
    }
    public ScrewConfig ignoreTableNames(ArrayList<String> ignoreTableNameList){
        this.ignoreTableNameList = ignoreTableNameList;
        return this;
    }

    public ScrewConfig ignorePrefixList(ArrayList<String> ignorePrefixList){
        this.ignorePrefixList = ignorePrefixList;
        return this;
    }

    public ScrewConfig ignoreSuffixList(ArrayList<String> ignoreSuffixList){
