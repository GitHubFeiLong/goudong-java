package com.goudong.modules.seata.client.b;
...
@EntityScan("com.goudong.modules.seata.client.b.po")
@EnableJpaRepositories(basePackages = {"com.goudong.modules.seata.client.b.repository"})
...
public class SeataClientBApplication {
    ...
    public static void main(String[] args) {
        ...
        stopWatch.start();
        ConfigurableApplicationContext context = new SpringApplicationBuilder(SeataClientBApplication.class)
