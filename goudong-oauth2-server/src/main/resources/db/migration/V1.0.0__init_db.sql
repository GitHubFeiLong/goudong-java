...
DROP TABLE IF EXISTS `authority_ignore_resource`;
...
DROP TABLE IF EXISTS `invalid_email`;
...
INSERT INTO `authority_ignore_resource` (`uuid`,`url`,`method`,`remark`,`is_delete`,`update_time`,`create_time`) VALUES ('1', '/swagger-ui.html', 'GET', 'swagger', 0, '2021-04-03 20:54:08', '2021-04-03 20:54:08'),('10', '/api/user/**', 'GET', NULL, 0, '2021-04-04 20:50:13', '2021-04-04 20:50:13'),('11', '/oauth/qq/**', 'GET', NULL, 0, '2021-05-01 21:54:21', '2021-05-01 21:54:21'),('2', '/swagger-ui/*', 'GET', NULL, 0, '2021-04-03 20:54:24', '2021-04-03 20:54:24'),('3', '/swagger-resources/**', 'GET', NULL, 0, '2021-04-03 20:54:40', '2021-04-03 20:54:40'),('4', '/druid/**', 'GET,POST', NULL, 0, '2021-04-04 11:24:23', '2021-04-04 11:24:23'),('5', '/v3/api-docs', 'GET', NULL, 0, '2021-04-03 20:55:01', '2021-04-03 20:55:01'),('6', '/actuator/**', 'GET', NULL, 0, '2021-04-04 15:21:56', '2021-04-04 15:21:56'),('7', '/**/*.css', 'GET', NULL, 0, '2021-04-04 15:35:22', '2021-04-04 15:35:22'),('8', '/**/*.ico', 'GET', NULL, 0, '2021-04-04 15:35:51', '2021-04-04 15:35:51'),('9', '/**/*.js', 'GET', NULL, 0, '2021-04-04 15:36:02', '2021-04-04 15:36:02');

INSERT INTO `authority_menu` (`uuid`,`url`,`method`,`menu_name`,`parent_uuid`,`remark`,`is_delete`,`update_time`,`create_time`) VALUES ('40cbd232-b1f8-11eb-b496-b42e99aedacc', '/api/user/hello', 'get', NULL, NULL, NULL, 0, '2021-04-03 17:52:07', '2021-04-03 17:52:07');

INSERT INTO `authority_role` (`uuid`,`role_name`,`role_name_CN`,`remark`,`is_delete`,`update_time`,`create_time`) VALUES ('2fe7f699-b1f6-11eb-b496-b42e99aedacc', 'ROLE_ADMIN', '管理员', '', 0, '2021-05-11 09:14:08', '2021-05-11 09:14:08'),('aa22cae8-b1f7-11eb-b496-b42e99aedacc', 'ROLE_ORDINARY', '普通角色', NULL, 0, '2021-05-11 09:24:43', '2021-05-11 09:24:43');

INSERT INTO `authority_role_menu` (`uuid`,`role_uuid`,`menu_uuid`,`is_delete`,`update_time`,`create_time`) VALUES ('2dd05b3d-b1f8-11eb-b496-b42e99aedacc', '2fe7f699-b1f6-11eb-b496-b42e99aedacc', '40cbd232-b1f8-11eb-b496-b42e99aedacc', 0, '2021-04-03 17:52:14', '2021-04-03 17:52:14');

INSERT INTO `authority_user` (`uuid`,`username`,`password`,`email`,`phone`,`nickname`,`remark`,`valid_time`,`is_delete`,`update_time`,`create_time`,`qq_open_id`) VALUES ('ed7bc254-b1f7-11eb-b496-b42e99aedacc', 'admin', '$2a$10$8ptteV1xP51AjOS/u6NAle/1Pw2BUsS.D/mbGuhauf.qc.oTikeAy', '1', '15213507716', NULL, NULL, '2021-05-08 15:51:25', 0, '2021-04-03 15:48:39', '2021-04-03 15:48:39', NULL);

INSERT INTO `authority_user_role` (`uuid`,`user_uuid`,`role_uuid`,`is_delete`,`update_time`,`create_time`) VALUES ('0a233801-b1f8-11eb-b496-b42e99aedacc', 'ed7bc254-b1f7-11eb-b496-b42e99aedacc', '2fe7f699-b1f6-11eb-b496-b42e99aedacc', 0, '2021-04-03 16:52:22', '2021-04-03 16:52:22');
