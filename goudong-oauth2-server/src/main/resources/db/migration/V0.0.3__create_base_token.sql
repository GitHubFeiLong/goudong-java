...
CREATE TABLE `base_token` (
          ...
          KEY `idx_base_token_user_id_client_type` (`user_id`,`client_type`) USING BTREE COMMENT 'user_id,client_type联合索引'
) ENGINE=InnoDB AUTO_INCREMENT=1485166940552040449 DEFAULT CHARSET=utf8 COMMENT='用户token记录';